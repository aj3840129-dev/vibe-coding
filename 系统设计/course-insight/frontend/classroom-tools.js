...
function renderManagementReview(review) {
  ...
  if (!node) { node = document.createElement("section"); node.id="reviewManagement"; node.className="management-panel"; byId("reviewView").querySelector(".workspace-body").append(node); }
